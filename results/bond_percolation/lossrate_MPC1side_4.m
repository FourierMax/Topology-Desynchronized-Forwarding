function [fitresult, gof] = lossrate_MPC1side_4(LOGX, Dropped_rate_MPC1_side)
...
%  由 MATLAB 于 01-Sep-2025 14:42:24 自动生成
...
opts.Robust = 'LAR';
opts.StartPoint = [0.992 0 0.730600057810321 0.863479781026304 -1.38721614328026 0.236480400898147];
